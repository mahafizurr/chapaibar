  ...
  return (
    <div>
      <div className="flex justify-center">
        <div className="bg-white m-2 shadow-lg p-6  md:p-10 rounded-lg text-center w-full max-w-md">
          <img
      ...
      <div className=" bg-gray-100 p-2 min-h-screen flex items-center justify-center flex-wrap">
        <div className="bg-white m-2 shadow-lg p-6 md:p-10 rounded-lg text-center w-80 max-w-md">
          <img
